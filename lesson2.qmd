...
<html lang="en">
    ...
    <head>
        ...
        <title>Lesson 2 – Enemy Fish & Collision Detection (Kontra.js)</title>
        <style>
            body {
        ...
        <main>
            ...
            <section>
                <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;">
                    <iframe
                            src="https://drive.google.com/file/d/1AwTphbfmyOQI6WljTnNrt9mDOd5ixr9q/preview"
            ...
            <section>
                ...
                <p>We’ll start with just one enemy fish — a red rectangle that moves across the screen.</p>
                <h3>✅ Code Reference</h3>
                <p>Add this code after player declaration and before the game loop:</p>
                ...
                <img width="100%" src="screenshots/image1_enemysprite.png" alt="Enemy rectangle example">

                <p>This red rectangle acts as the bad fish. It starts on the right side (x: 800) and slowly moves left
                    because of <code>dx: -2</code>. The <code>update()</code> function keeps it moving, and <code>draw()</code>
                    draws it.</p>
                <img width="100%" src="screenshots/image3_enemyonthescreen.png" alt="Enemy rectangle example">
            </section>

            <section>
                <h2>Step 2: Make Enemy Speed Random</h2>
                <p>“We don’t want every enemy to move the same way. Let’s use random numbers to make them
                    different.”</p>
            ...
            <section>
                ...
                <p>We don’t want enemies to exist forever. When they leave the screen, we clean them up.</p>
                <p>Add this inside the enemy’s <code>update()</code> function:</p>
            ...
            <section>
                ...
                <p>Update your game loop’s <code>update()</code> and <code>render()</code> to handle all enemies in this
                    list.</p>
                ...
                <img width="100%" src="screenshots/image6_enemylist.png" alt="Enemy list array">
            </section>

            <section>
                <div style="position:relative;padding-bottom:56.25%;height:0;overflow:hidden;">
                    <iframe
                            src="https://drive.google.com/file/d/1IglC0aatwQr4nVkXG5gvpIgZj02ZCf7P/preview"
                            style="position:absolute;top:0;left:0;width:100%;height:100%;"
                            allow="autoplay">
            ...
            <section>
                ...
                <p>We don’t want all enemies at once! Let’s use a timer to spawn new enemies every second.</p>
                ...
                <a href=https://github.com/aiwhoo/GameGarageBook/blob/main/lesson%202%20Enemies/step5.1_spawntimer.html
                   class="step-link" target="_blank">👉 View Step 5.1 Code</a>
                <img width="100%" src="screenshots/image7_spawntimer.png" alt="Spawn timer illustration">
            </section>

            <section>
                <h2>Step 5.2: Spawning New Enemies</h2>
                <p>Inside your Game Loop's <code>update()</code> function, check the timer and create a new enemy when it reaches 0.
                </p>
                ...
                <a href=https://github.com/aiwhoo/GameGarageBook/blob/main/lesson%202%20Enemies/step5.2_spawningnewenemies.html
                   class="step-link" target="_blank">👉 View Step 5.2 Code</a>
            ...
            <section>
                ...
                <p>Now let’s check if the player touches an enemy. If they collide, the enemy changes color.</p>
                ...
                <img width="100%" src="screenshots/image10_collisiondiagram.png" alt="Collision diagram">
            </section>
            ...
            <section>
                ...
                <img width="100%" src="screenshots/image11_checkingcollision.png" alt="Collision visual example">
            </section>
            ...
            <section>
                ...
                <ul>
                    <li>You can see your player fish swimming while new red enemy fish keep appearing and moving. When
                        they bump into each other, the enemies change color — showing your collision detection works
                    </li>
                </ul>
            </section>
